...
@vite('resources/css/app.css')
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col">
                    <h2 class="font-weight-700">All Jewelries in Store</h2>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
          <div class="py-12">
               <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <section>
                    <div class="my-4">
                        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" wire:click="create">Add Product</button>
                    </div>
                    @if($isOpen)
                    <div class="fixed inset-0 flex items-center justify-center z-50">
                        ...
                        <div class="relative bg-gray-200 p-8 rounded shadow-lg w-1/2">
                           ...
                           <path d="M14.53 4.53l-1.06-1.06L9 7.94 4.53 3.47 3.47 4.53 7.94 9l-4.47 4.47 1.06 1.06L9 10.06l4.47 4.47 1.06-1.06L10.06 9z" />
                            ...
                            <h2 class="text-2xl font-bold mb-4">{{ $postId ? 'Edit Product' : 'Add Product' }}</h2>
    ...
    <div class="row md-3 p-2">
         ...
         <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-3">
             <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                 ...
                 @forelse ($jewelry as $post)
                 <tbody wire:key="{{ $post->id }}">
                     <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                         <td class="px-6 py-4 text-white-900">
                             <img src="{{ Storage::url($post->image)}}" alt="Uploaded Image Preview" style="max-width: 80px;">
                         </td>
                         <td class="px-6 py-4 text-white-900">
                             {{$post->jewelry_name}}
                         </td>
